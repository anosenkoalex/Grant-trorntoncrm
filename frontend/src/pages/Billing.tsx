...
export default function BillingPage() {
  ...
  const portalMutation = useMutation({
    mutationFn: () => createPortalSession(window.location.origin + '/billing'),
    onSuccess: ({ url }) => {
  ...
  const invoiceColumns = [
    ...
    },
    {
      ...
      render: (v: string) => (
        <Tag
          color={v === 'paid' ? 'green' : v === 'open' ? 'orange' : 'default'}
        >
          {v.toUpperCase()}
        </Tag>
      ),
          ...
          <Row gutter={[16, 16]} style={{ marginBottom: 24 }}>
              ...
              <Card>
                <Descriptions column={1} size="small" title="Current Plan">
                  <Descriptions.Item label="Plan">
                    <Space>
                      <Tag color={PLAN_COLORS[sub.plan]}>
                  ...
                  <Descriptions.Item label="Status">
                    <Tag color={STATUS_COLORS[sub.status]}>
            ...
            <Col xs={24} sm={12}>
              ...
              >
                ...
                >
                  Upgrade, downgrade, change payment method, or cancel your
